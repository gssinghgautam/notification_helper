package com.ohphish.notification_helper.utils;
...
import com.ohphish.notification_helper.model.Action;
import com.ohphish.notification_helper.model.NotificationIds;
...
//            msg += tv.getText().toString() + '\n';
    ...
    public static String getTitle(Bundle extras) {
        ...
        String msg = extras.getString(Notification.EXTRA_TITLE).toString();
        Log.d("Title Big", "" + extras.getString(Notification.EXTRA_TITLE_BIG).toString());
        return msg;
    }
    ...
    public static String getExpandedText(ViewGroup localView) {
        ...
        if (localView != null) {
            ...
            if (text.equals("")) //Last resort for Kik
            {
                ...
                } else if (bigTitleView instanceof TextView) {
                    text += ((TextView) titleView).getText();
                } else if (inboxTitleView instanceof TextView) {
                    text += ((TextView) titleView).getText();
                }
